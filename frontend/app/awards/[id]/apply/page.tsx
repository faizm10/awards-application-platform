    ...
    try {
      ...
      if (result) {
        ...
        toast.success("Draft Saved Successfully!", {
          description: "Your application draft has been saved. You can continue editing or submit it later.",
          duration: 3000,
        });
      } else {
    ...
    try {
      ...
      if (result) {
        toast.success("Application Submitted Successfully!", {
          description: `Your application for ${award.title} has been submitted and is now under review. You will receive updates on your application status.`,
          duration: 5000,
        });
