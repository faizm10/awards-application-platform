...
import { getAwardsWithStats, type AwardWithStats } from "@/lib/admin"
...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const awardsData = await getAwardsWithStats()
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground">Manage awards and applications</p>
        </div>
        <Button asChild>
