...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <div
      className={cn(
        "relative z-[60] mx-auto w-full max-w-7xl flex-row items-center justify-between rounded-full bg-white/80 dark:bg-neutral-950/80 backdrop-blur-sm px-4 py-4 lg:flex",
        className
      )}
    >
      {children}
...
export const MobileNav = ({ children, className, visible }: MobileNavProps) => {
  return (
    <div
      className={cn(
        "relative z-50 mx-auto flex w-full max-w-[calc(100vw-2rem)] flex-col items-center justify-between bg-white/80 dark:bg-neutral-950/80 backdrop-blur-sm px-4 py-4 lg:hidden rounded-full",
        className
      )}
    >
      {children}
